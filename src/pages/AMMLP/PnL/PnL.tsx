    ...
    return (
        <Container>
            ...
            {!noData ? (
                    ...
                    <ResponsiveContainer width="100%" height="100%">
                        <Chart data={liquidityPoolPnls}>
                            ...
                            <XAxis
                                ...
                                tickLine={false}
                                axisLine={false}
                                tick={{ fill: theme.textColor.tertiary }}
                                style={{
                                    fontSize: '13px',
                                }}
                            />
                            ...
                            <Tooltip
                                ...
                                cursor={{ fill: theme.textColor.tertiary, fillOpacity: '0.2' }}
                            ...
                            {type === LiquidityPoolPnlType.PNL_PER_ROUND ? (
                                <Bar dataKey="pnlPerRound" radius={[4, 4, 0, 0]} maxBarSize={60}>
                                    {liquidityPoolPnls.map((entry, index) => (
                                        <Cell
                                            key={`cell-${index}`}
                                            fill={entry.pnlPerRound > 0 ? theme.chart.positive : theme.chart.negative}
                                        />
                                    ))}
                                </Bar>
                            ) : (
                ...
                <NoData>{t(`staking.amm-lp.pnl.no-data`)}</NoData>
            )}
        </Container>
    );
};
