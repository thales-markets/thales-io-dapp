...
const MaxAllowanceTooltip: React.FC<MaxAllowanceTooltipProps> = ({ stakedThales, stakedThalesMultiplier }) => {
    ...
    return (
        <Container>
            <ContentContainer>
                <Label>{t('staking.amm-lp.your-thales-staked-label')}</Label>
                <Text>{formatCurrency(stakedThales)}</Text>
            </ContentContainer>
            <MiddleContainer>x</MiddleContainer>
            <ContentContainer>
                <Label>{t('staking.amm-lp.allowance-multiplier-label')}</Label>
                <Text>{stakedThalesMultiplier}</Text>
            </ContentContainer>
            <MiddleContainer>=</MiddleContainer>
            <ContentContainer>
                <Label>{t('staking.amm-lp.max-allowance-label')}</Label>
